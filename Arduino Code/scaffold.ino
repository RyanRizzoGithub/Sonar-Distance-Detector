...
void loop() {  
  ...
  // Step 5: Add artificial delay between successive data transfers to simulate the 
    // Arduino doing something (e.g. reading from a sensor).  Also add a heartbeat LED,
    // to let the user know the program is active.     
